public class NightBorneHitState : NightBorneState
{
    public NightBorneHitState(FSM fsm, NightBorne character, string animBoolName) : base(fsm, character, animBoolName)
    {
    }

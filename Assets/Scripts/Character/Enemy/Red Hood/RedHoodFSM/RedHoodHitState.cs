public class RedHoodHitState : RedHoodState
{
    public RedHoodHitState(FSM fsm, RedHood character, string animBoolName) : base(fsm, character, animBoolName)
    {
    }
    ...
    public override void Enter(IState lastState)
    {
        ...
        AudioManager.instance.PlaySFX(6, Character.transform);

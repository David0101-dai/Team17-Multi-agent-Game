...
public class NightBornePatrolState : NightBorneGroundState
{
    public NightBornePatrolState(FSM fsm, NightBorne character, string animBoolName) : base(fsm, character, animBoolName)
    {
    }

...
public class NightBorneStunState : NightBorneState
{
    public NightBorneStunState(FSM fsm, NightBorne character, string animBoolName) : base(fsm, character, animBoolName)
    {
    }
